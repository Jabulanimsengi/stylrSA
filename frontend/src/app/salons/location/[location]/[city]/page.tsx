...
// City names mapping (same as in layout.tsx)
...
function SalonsCityContent() {
  ...
  const cityName = CITY_NAMES[provinceSlug]?.[citySlug] || citySlug.charAt(0).toUpperCase() + citySlug.slice(1);
...
export default function SalonsCityPage() {
  return (
